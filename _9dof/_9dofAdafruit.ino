...
void displayHMC5883SensorDetails(void)
{
  sensor_t sensor;
...
void loop(void) 
{
  ...
  Serial.print("ADXL345 = X: "); Serial.print(event.acceleration.x); Serial.print("  ");
  Serial.print("Y: "); Serial.print(event.acceleration.y); Serial.print("  ");
  Serial.print("Z: "); Serial.print(event.acceleration.z); Serial.print("  "); Serial.println("m/s^2 ");
  
  mag.getEvent(&event); 
  /* Display the results (magnetic vector values are in micro-Tesla (uT)) */
  Serial.print("HMC5883 = X: "); Serial.print(event.magnetic.x); Serial.print("  ");
  ...
  Serial.print("Heading: "); Serial.print(headingDegrees); Serial.write(176); Serial.println(""); Serial.println("");
  delay(500);
}
